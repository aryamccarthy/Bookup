...
class OneFileLoginApplication
{
    ...
    private function createNewUser()
    {
        ...
        $result_row = $query->fetchObject();
        if ($result_row) {
            $this->feedback = "Sorry, that email is already taken. Please choose another one.";
        } else {
    ...
    private function showPageLoginForm()
    {
        ...
        echo '<label for="login_input_username">Email</label> ';
        echo '<input id="login_input_username" type="text" name="user_email" required /> ';
